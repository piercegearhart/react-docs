...
import Simplecode from '../components/sections/simplecode'
                ...
                <section id='adding-pages' className='mb-16'>
                    ...
                    <div className='body'>
                        ...
                        <Codeblock spacing={true}>
                            ...
                            <span style={{marginLeft: '96px'}}>{"<section className='mb-16'>"}</span><br />
                ...
                <section id='content-sections' className='mb-16'>
                    ...
                    <div className='mb-16'>
                        ...
                        <div className='body'>
                            ...
                            <Codeblock spacing={true}>
                                {'<Title>'}<br />
                                <span style={{marginLeft: '24px'}}>// Text Here</span><br />
                                {'</Title>'}
                            </Codeblock>
                            <Text spacing={true}>
                                Simply change the <Simplecode>// Text Here</Simplecode> to the text you'd like to be displayed. For example, the text above that says <Simplecode>Title Component:</Simplecode> is displayed 
                                using the title section code.
                            </Text>
                        </div>
                    </div>
                    <div className='mb-16'>
                    ...
                    <div className='mb-16'>
                        ...
                        <div className='body'>
                            <Text spacing={true}>
                                Last, but surely not least, the codeblock component. Like the simple code component, this is used to make important information stand out, but separate it from the
